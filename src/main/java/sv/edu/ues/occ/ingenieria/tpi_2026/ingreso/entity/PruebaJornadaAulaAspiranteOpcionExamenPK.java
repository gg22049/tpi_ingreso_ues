...
public class PruebaJornadaAulaAspiranteOpcionExamenPK implements Serializable {
    ...
    public PruebaJornadaAulaAspiranteOpcionExamenPK(long idPrueba, long idJornada, String idAula, long idAspiranteOpcion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PruebaJornadaAulaAspiranteOpcionExamenPK)) {
            return false;
        }
        PruebaJornadaAulaAspiranteOpcionExamenPK other = (PruebaJornadaAulaAspiranteOpcionExamenPK) object;
    ...
    public String toString() {
        return "sv.edu.ues.occ.ingenieria.tpi_2026.ingreso.entity.PruebaJornadaAulaAspiranteOpcionExamenPK[ idPrueba=" + idPrueba + ", idJornada=" + idJornada + ", idAula=" + idAula + ", idAspiranteOpcion=" + idAspiranteOpcion + " ]";
    }
