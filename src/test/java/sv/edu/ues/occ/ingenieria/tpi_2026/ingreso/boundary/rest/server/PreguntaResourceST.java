...
public class PreguntaResourceST extends STAbstract {
    ...
    @Order(2)
    void findById() {
        System.out.println("PreguntaResource.findById");
    ...
    public void findByRange() {
        System.out.println("PreguntaResource.findByRange");
    ...
    @Order(5)
    public void delete() {
        System.out.println("PreguntaResource.delete");
