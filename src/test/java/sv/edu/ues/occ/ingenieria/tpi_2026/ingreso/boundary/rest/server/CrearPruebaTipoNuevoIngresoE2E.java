...
public void creo_una_prueba(io.cucumber.datatable.DataTable dataTable) {
    // Write code here that turns the phrase above into concrete actions
...
@When("creo una clave para la prueba llamada {string}")
public void creo_una_clave_para_la_prueba_llamada(String string) {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
@Then("puedo consultar la prueba recien creada")
public void puedo_consultar_la_prueba_recien_creada() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
@Then("verifico que la prueba tiene asociado el tipo {string}")
public void verifico_que_la_prueba_tiene_asociado_el_tipo(String string) {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
@Then("verifico que la prueba tiene asociada la clave {string}")
